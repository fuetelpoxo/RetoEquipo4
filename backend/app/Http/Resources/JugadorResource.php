...
class JugadorResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'equipo' => new EquipoResource($this->equipo),  // Relación con el equipo (devuelve solo un objeto)
            'estudio' => new EstudioResource($this->estudio),  // Relación con el estudio
            'actas' => ActaResource::collection($this->actas),  // Relación con las actas
            'imagenes' => ImagenResource::collection($this->imagenes),  // Relación con las imágenes
            'publicaciones' => PublicacionResource::collection($this->publicaciones),  // Relación con las publicaciones
        ];
    }
}
