...
class EquipoResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'nombre' => $this->nombre,
            'grupo' => $this->grupo,
            'centro' => new CentroResource($this->whenLoaded('centro')), // Centro al que pertenece el equipo
            ...
            'imagenes' => ImagenResource::collection($this->whenLoaded('publicaciones')), // Lista de imágenes
