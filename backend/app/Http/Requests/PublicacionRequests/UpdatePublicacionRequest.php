...
class UpdatePublicacionRequest extends FormRequest
{
    ...
    {
        return [
            'titulo' => 'nullable|string|max:255', // el título es obligatorio, debe ser una cadena y no exceder 255 caracteres
            'texto' => 'nullable|string', // el texto es obligatorio y debe ser una cadena
