...
class PublicacionController extends Controller
{
     ...
     * @OA\Property(property="titulo", type="string", example="Título de la publicación"),
     * @OA\Property(property="texto", type="string", example="Texto de la publicación"),
     * @OA\Property(property="portada", type="string", example="Portada de la publicación"),
     * @OA\Property(property="rutavideo", type="string", example="Ruta del video de la publicación"),
     * @OA\Property(property="rutaaudio", type="string", example="Ruta del audio de la publicación"),
